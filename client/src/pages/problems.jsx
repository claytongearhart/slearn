...
import { Text, Input, Spacer, Button, Popover, Keyboard } from "@geist-ui/core";
  ...
  const handleKeyDown = (e) => {
    ...
    if (e.key === "Enter") {
      if (e.shiftKey) {
        ...
        console.log(problem.ansChecker(ans.replaceAll(/\\left|\\right/g, "")));
      }
    }
  };
...
function LogPowPropGen() {
  ...
  return {
    question: "Simplify Into a Single Logarithm",
    expression: ques,
    ansChecker: (uAns) => latexEqual(uAns, ques, cVars),
  };
}
