...
function tokenizeTex(texStr) {
    ...
    while (i < length) {
        ...
        if (!isAlpha(c) && c in Token_1.lexemeToType) {
            type = Token_1.lexemeToType[c];
            lexeme = c;
        }
        else if (c === '\\') {
            ...
            if (nextChar === '\\') {
                ...
                if (command === undefined) {
                    ...
                    lexeme = `\\${command}`;
                    type = Token_1.lexemeToType[lexeme];
                    if (type === undefined) {
        ...
        if (type !== 48 /* Space */) {
            tokens.push(new Token_1.default(lexeme, type, i));
        }
        i += lexeme.length;
    }
    tokens.push(new Token_1.default('EOF', 37 /* Eof */, i));
    return tokens;
}
